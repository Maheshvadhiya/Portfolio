    ...
    <StyledForm>
      <Form noValidate validated={isValidated} onSubmit={handleSubmit}>
        <Form.Group className="mx-auto mb-3 form-group" controlId="name">
          ...
          <Form.Control required type="text" placeholder="Your name" style={{ height:40 }} />
          <Form.Control.Feedback type="invalid">
            <h6>Name must be at least one character.</h6>
        ...
        <Form.Group className="mx-auto mb-3 form-group" controlId="message">
          ...
          <Form.Control required as="textarea" placeholder="Your message..." style={{ height:80 }}/>
          <Form.Control.Feedback type="invalid">
            <h6>Please provide a valid message.</h6>
          </Form.Control.Feedback>
        </Form.Group>
